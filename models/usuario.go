...
type Usuario struct {
    ...
    Banner      string              `bson:"banner" json:"avatar,omitempty"`
    Biografia   string              `bson:"biografia" json:"avatar,omitempty"`
    Ubicacion   string              `bson:"ubicacion" json:"avatar,omitempty"`
